<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApartmentPreview.aspx.cs" Inherits="WebApplication1.ApartmentPreview" %>
            ...
            <div class="grid-container">
                <div class="images">
                    ...
                    <div class="small-images" style="margin-top: 50px;">
                        ...
                        <asp:Image ID="imgA" src="/images/Renting/Apt1/dining.png" class="imgthumb preview" runat="server"/>
                        <asp:Image ID="imgB" src="/images/Renting/Apt1/kitchen.png" class="imgthumb preview" runat="server"/>
                        <asp:Image ID="imgC" src="/images/Renting/Apt1/living.png" class="imgthumb preview" runat="server"/>
                        <asp:Image ID="imgD" src="/images/Renting/Apt1/backyard.png" class="imgthumb preview" runat="server"/> 
                    </div>
                </div>
