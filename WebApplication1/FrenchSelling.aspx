<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrenchSelling.aspx.cs" Inherits="WebApplication1.FrenchSelling" %>
    ...
    <body style="height: 627px">
        <form id="form1" runat="server" enctype="multipart/form-data">
            ...
            <div class="grid-container">
                <div class="images">
                    <h2 class="instruction-headings">Télécharger le devant de la propriété</h2>
                    ...
                    <h2 class="instruction-headings">Téléchargez d'autres images de la propriété</h2>
                ...
                <div class="extra-info">
                    ...
                    <h2 class="instruction-headings" style="margin: 0;">Informations supplémentaires</h2>
                        <asp:TextBox ID="TextBox1" runat="server" Width="900px" Height="80px" Rows="4" TextMode="MultiLine" Placeholder="Informations supplémentaires que l'acheteur pourrait trouver utiles."></asp:TextBox>
                        <br /><a href="PostedProperty.aspx" class="button3" style="margin-top: 10px;">Aperçu</a>
                    </div>
                </div>
            </div>
